...
namespace Dropbox.Api.Files
{
    ...
    public class Metadata:Gabriel.Cat.Nube.IElementoNube
    {
        ...
        /// </summary>
        public string PathNube { get; protected set; }//mirar si es el path publico para descargarlo
        ...
        private class MetadataEncoder : enc.StructEncoder<Metadata>
        {
            ...
            public override void EncodeFields(Metadata value, enc.IJsonWriter writer)
            {
                ...
                if (value.PathNube != null)
                {
                    WriteProperty("path_display", value.PathNube, writer, enc.StringEncoder.Instance);
                }
            ...
            protected override void SetField(Metadata value, string fieldName, enc.IJsonReader reader)
            {
                switch (fieldName)
                {
                    ...
                    case "path_lower":
                        ...
                        break;
                    case "path_display":
                        value.PathNube = enc.StringDecoder.Instance.Decode(reader);
                        break;
